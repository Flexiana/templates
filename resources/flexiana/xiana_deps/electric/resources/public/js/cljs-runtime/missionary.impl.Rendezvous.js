...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__11925__auto__){
var self__ = this;
var self__ = this;
var G__40470 = (arguments.length - (1));
switch (G__40470) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args40468){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40468)));
}));
...
var G__40478 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40478) : f_BANG_.call(null,G__40478));
} else {
return null;
}
});
} else {
var vec__40481 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40481,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__40467_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40467_SHARP_) : s_BANG_.call(null,p1__40467_SHARP_));
});
...
var G__40488 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40488) : f_BANG_.call(null,G__40488));
} else {
return null;
}
});
} else {
var vec__40491 = temp__5806__auto__;
var vec__40494 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40491,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40494,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40494,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
