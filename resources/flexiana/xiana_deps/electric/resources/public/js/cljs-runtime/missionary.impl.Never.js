...
(missionary.impl.Never.Process.prototype.call = (function (unused__11925__auto__){
var self__ = this;
var self__ = this;
var G__40671 = (arguments.length - (1));
switch (G__40671) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args40670){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40670)));
}));
...
var G__40680 = (new missionary.Cancelled("Never cancelled."));
var fexpr__40679 = ps.f;
