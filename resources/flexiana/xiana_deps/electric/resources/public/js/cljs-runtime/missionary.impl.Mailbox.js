...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__11925__auto__){
var self__ = this;
var self__ = this;
var G__40602 = (arguments.length - (1));
switch (G__40602) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args40600){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40600)));
}));
...
var vec__40613 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40613,(0),null);
...
var _BANG_ = (function (p1__40595_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40595_SHARP_) : s_BANG_.call(null,p1__40595_SHARP_));
});
...
var G__40616 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40616) : f_BANG_.call(null,G__40616));
} else {
return null;
}
});
...
var G__40617_40635 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__40617_40635) : s_BANG_.call(null,G__40617_40635));

return missionary.impl.Mailbox.nop;
}
} else {
var G__40618_40636 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__40618_40636) : s_BANG_.call(null,G__40618_40636));
