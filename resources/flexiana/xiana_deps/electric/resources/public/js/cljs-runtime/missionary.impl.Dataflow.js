...
(missionary.impl.Dataflow.Port.prototype.call = (function (unused__11925__auto__){
var self__ = this;
var self__ = this;
var G__40592 = (arguments.length - (1));
switch (G__40592) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args40591){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40591)));
}));
...
var _BANG_ = (function (p1__40590_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__40590_SHARP_) : s_BANG_.call(null,p1__40590_SHARP_));
});
...
var G__40593 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__40593) : f_BANG_.call(null,G__40593));
} else {
return null;
}
}
