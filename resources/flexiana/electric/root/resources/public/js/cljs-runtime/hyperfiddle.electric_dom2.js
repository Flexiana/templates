...
/** @this {Function} */
(hyperfiddle.electric_dom2.unsupported.cljs$lang$applyTo = (function (seq47683){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47683));
}));
...
var G__47684 = x.parentNode;
if((G__47684 == null)){
return null;
} else {
return G__47684.removeChild(x);
}
});
...
var el = (function (){var G__47685 = type;
...
var vec__47688 = hyperfiddle.electric_dom2.resolve_attr_alias(attr);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47688,(0),null);
var attr__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47688,(1),null);
...
return hyperfiddle.electric_dom2.listen(node,typ,(function (p1__47696_SHARP_){
var G__47697 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__47696_SHARP_) : f.call(null,p1__47696_SHARP_));
return (_BANG_.cljs$core$IFn$_invoke$arity$1 ? _BANG_.cljs$core$IFn$_invoke$arity$1(G__47697) : _BANG_.call(null,G__47697));
}),cljs.core.clj__GT_js(opts));
})));
});
hyperfiddle.electric_dom2.happen = (function hyperfiddle$electric_dom2$happen(s,e){
var G__47698 = new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(s);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47698__$1)].join('')));
