...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28397){
var G__28398 = cljs.core.first(seq28397);
var seq28397__$1 = cljs.core.next(seq28397);
var G__28399 = cljs.core.first(seq28397__$1);
var seq28397__$2 = cljs.core.next(seq28397__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28398,G__28399,seq28397__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28426_SHARP_){
return (!((cljs.core.meta(p1__28426_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28448__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28450){var _e__27739__auto__ = e28450;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e28452){var _e__27739__auto__ = e28452;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28455 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28456 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28456);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28457__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28455);
}});
...
var temp__5802__auto___28526 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___28526)){
var managed_print_level_28527 = temp__5802__auto___28526;
var _STAR_print_level_STAR__orig_val__28460_28528 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28461_28529 = managed_print_level_28527;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28461_28529);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28459_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28459_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28460_28528);
}} else {
job_fn();
}
