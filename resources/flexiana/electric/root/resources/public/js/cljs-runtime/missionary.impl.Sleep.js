...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__11925__auto__){
var self__ = this;
var self__ = this;
var G__40667 = (arguments.length - (1));
switch (G__40667) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args40666){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args40666)));
}));
...
var G__40683 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__40682 = s.failure;
