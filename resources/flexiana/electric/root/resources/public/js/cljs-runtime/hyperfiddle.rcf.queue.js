...
var hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_38047 = (function (this$,val){
...
return hyperfiddle$rcf$queue$IObservableQueue$put_BANG_$dyn_38047(this$,val);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_38050 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$take_BANG_$dyn_38050(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_38051 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$_empty_QMARK_$dyn_38051(this$);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_38052 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$observe_BANG_$dyn_38052(this$,callback);
}
});

var hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_38053 = (function (this$,callback){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return hyperfiddle$rcf$queue$IObservableQueue$unobserve_BANG_$dyn_38053(this$,callback);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto___38076 = self__.observers.shift();
if(cljs.core.truth_(temp__5802__auto___38076)){
var observer_38077 = temp__5802__auto___38076;
(observer_38077.cljs$core$IFn$_invoke$arity$1 ? observer_38077.cljs$core$IFn$_invoke$arity$1(val) : observer_38077.call(null,val));
} else {
self__.arr.push(val);
}
...
var G__38041 = q;
var G__38042 = start;
var G__38043 = timeout;
var G__38044 = missing_value;
var G__38045 = (n - (1));
var G__38046 = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(callback,x);
return (hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6 ? hyperfiddle.rcf.queue.poll_n_BANG_.cljs$core$IFn$_invoke$arity$6(G__38041,G__38042,G__38043,G__38044,G__38045,G__38046) : hyperfiddle.rcf.queue.poll_n_BANG_.call(null,G__38041,G__38042,G__38043,G__38044,G__38045,G__38046));
}
}));
});
